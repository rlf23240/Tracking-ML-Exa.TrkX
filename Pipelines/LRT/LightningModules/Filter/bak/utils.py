...
def load_dataset(input_dir, num, pt_background_cut, pt_signal_cut, eta_signal_cut, true_edges, noise):
    if input_dir is not None:
        ...
        loaded_events = select_data(
            loaded_events, pt_background_cut, pt_signal_cut, eta_signal_cut, true_edges, noise
        )
...
def select_data(events, pt_background_cut, pt_signal_cut, eta_signal_cut, true_edges, noise):

...
class EmbeddingBase(LightningModule):
    ...
    def setup(self, stage):
        # Temp
        self.hparams['input_dir'] = '/global/cscratch1/sd/ianwang/LRT/v3/pileup40/feature_store'
        self.hparams['output_dir'] = '/global/cscratch1/sd/ianwang/LRT/v3/pileup40/embedding_processed'
